...
constexpr std::string_view password_authenticator_name("org.apache.cassandra.auth.RestAuthenticator");
...
static const class_registrator<
        ...
        ::service::migration_manager&> rest_auth_reg("org.apache.cassandra.auth.RestAuthenticator");

static thread_local auto rng_for_salt = std::default_random_engine(std::random_device{}());

rest_authenticator::~rest_authenticator() {
}
...
// TODO: Do we need this? Probably for superuser creation
