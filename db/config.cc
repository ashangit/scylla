...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , rest_authenticator_endpoint_port(this, "rest_authenticator_endpoint_port", value_status::Used, 0, "Port to contact the external rest endpoint used to authenticate users.")
